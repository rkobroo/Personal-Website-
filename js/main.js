  ...
  (function() {
    ...
    function getReply(q) {
      ...
      if (/\bprojects?\b|\bwork\b|\bbuild\b|\bapps?\b|\bproduct\b|\bmade\b/.test(q)) {
        return '<b>Featured Projects:</b><br>1. <a href="https://rko-downloader.pages.dev" target="_blank">RKO Downloader</a> — Video downloader (Android)<br>2. <a href="https://tv-97x.pages.dev" target="_blank">RKO TV</a> — Live sports streaming<br>3. <a href="https://github.com/rkobroo/screenmirror-releases/releases/latest" target="_blank">MirrorLink (Screen Mirror)</a> — Phone mirroring to PC<br>   📱 <a href="https://github.com/rkobroo/screenmirror-releases/releases/latest/download/app-release.apk" target="_blank">Download Mobile APK</a> · 💻 <a href="https://github.com/rkobroo/screenmirror-releases/releases/latest/download/MirrorLink-Setup-2.4.1.exe" target="_blank">Download PC Installer</a><br>4. WWE Highlights — Wrestling clips app';
      }
      /* Experience */
